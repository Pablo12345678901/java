...
{   public static void main (String args[])
    {   int t1[] = {2,    5, 6,    8, 9} ;
        ...
        u1.addAll(e1) ;
        //copie (u1, e1) ;  // copie e1 dans u1  // pas nécessaire mais ci-dessous pour illustrer ce que fait addAll
        u1.addAll (e2) ;
        ...
        i1.addAll(e1) ;
        //copie (i1, e1) ; // pas nécessaire mais ci-dessous pour illustrer ce que fait addAll
        i1.retainAll (e2) ;
