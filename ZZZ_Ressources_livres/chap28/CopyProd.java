...
{ public static void main (String[] args)  throws ClassNotFoundException, SQLException 
  {     // recherche et enregistrement pilote
    Class.forName ("org.apache.derby.jdbc.EmbeddedDriver") ;
        // �tablissement de la connexion avec les bases stocks et stocksA
    ...
    stmtA.execute(requeteA) ;
        // cr�ation d'un objet ResultSet acutalisable 
    ...
    { String nom = res.getString(1) ; String ref = res.getString(2) ;
      ...
      double prixA = prix/100. ;   // car prix base stock exprmi� en cents
