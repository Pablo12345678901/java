...
{ public void affiche ()
  { afficheNature () ; 
    System.out.print(" de Coordonnees = " + x + " " + y) ;
    afficheAutresInfos () ;
  }
  abstract public void afficheNature () ;  // a redefinir obligatoirement
  public void afficheAutresInfos () { System.out.println(".") ; }    // version par defaut si pas redefinie
  protected int x, y ;        // pour eviter pb acces dans classes derivees
}

class Point extends Forme
{ public Point (int x, int y) { this.x = x ; this.y = y ; }
  public void afficheNature () { System.out.print ("Je suis un Point") ; }
...
{ public Cercle (int x, int y, double r) 
  ...
  private double r ; 
  public void afficheNature () { System.out.print ("Je suis un Cercle") ; }
